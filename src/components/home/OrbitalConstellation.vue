...
/* 左下角标题 */
.title-section {
  @apply absolute bottom-24 left-8 md:left-12 text-center;
...
.subtitle {
  @apply text-xs tracking-[0.3em] uppercase mt-3;
...
/* 底部链接 */
.bottom-link {
  @apply absolute bottom-4 left-8 md:left-12;
  animation: fadeIn 0.8s ease-out 0.6s backwards;
}

.bili-link {
  @apply inline-flex items-center gap-2 text-sm transition-all duration-300;
